//The original text is : 0123456789ABCDEF
//THe key used is : 133457799BBCDFF1
package d_e_s;
import java.io.*;
import java.util.*;
...
public class Encryption_Test 
{
    ...
    public static void round() throws FileNotFoundException
    {
    	...
    	for(int r=0;r<=15;r++)
    	{
    		round[r]=new FunctionFE(KG.subkeys,Right,Array32 ,r,r); 
    ...
    public static void FinalPermitation (int x[],int result[]) throws FileNotFoundException
    {
       ...
       PrintCipherMessage(result);
      
    }  	  
    

    public static void PrintCipherMessage(int[] result) throws FileNotFoundException
    {
    	PrintWriter output = new PrintWriter(new FileOutputStream("CipherMessage.txt"));
    	String q="";
 ...
 public static  void ReadKey() throws FileNotFoundException 
 {
    ...
    for(int i=0;i<a.length();i++)
    {
	 ...
	 {
		  	int q,c=0;
		    File file =new File("OriginalMessage.txt") ;
		    Scanner input=new Scanner(file);
